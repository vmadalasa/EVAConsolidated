...
from augmentation import MNIST_Transforms, CIFAR10_Transforms, CIFAR10_AlbumTrans, TinyImageNet_Transforms, TinyImageNet_AlbumTrans
...
class TinyImageNetDataLoader:
    ...
    def __init__(self, model_transform, batch_size=64, data_dir= './root', shuffle=True, nworkers=4, pin_memory=True):
        ...
        self.train_set = datasets.TinyImageNet(
            self.data_dir,
            train=True,
            download=True,
            transform=model_transform.build_transforms(train=True)
        ...
        self.test_set = datasets.TinyImageNet(
            self.data_dir,
            train=False,
            download=True,
            transform=model_transform.build_transforms(train=False)
